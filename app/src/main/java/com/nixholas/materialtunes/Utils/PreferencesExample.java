...
public class PreferencesExample {
    ...
    private static PreferencesExample sInstance;

    private static SharedPreferences mPreferences;

    public PreferencesExample(final Context context) {
        mPreferences = PreferenceManager.getDefaultSharedPreferences(context);
    }

    public static final PreferencesExample getInstance(final Context context) {
        if (sInstance == null) {
            sInstance = new PreferencesExample(context.getApplicationContext());
        }
        return sInstance;
    }
